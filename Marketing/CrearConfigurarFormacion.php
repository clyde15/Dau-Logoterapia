<html lang="es-ES" xml:lang="es-ES">
 ...
 ?>
  ...
  <form method="post" id="formularioCrearConfiguracionFormacion" >
    <input type="Hidden"  name="MetodoE" value="ConfigurarFormacion" />
    <input type="Hidden" name="idresponsable" id="idresponsable" value="<?php echo $idresp;?>" />
      <table>
          <tr>
              <td colspan="3"><legend>Configurar Formacion</legend></td>
          </tr>
          <tr>
              <td>       
                  ...
                  <div class="editor-field">
                        <select name="idformacion" id="idformacion" class="validarcampos">
                            <option></option>
                            <?php
              ...
              <td>
                    ...
                    <div class="editor-field">
                        <select name="gerente" id="gerente" class="validarcampos">
                            <option></option>
                            <?php
                            $queryperfil = "SELECT `idusuarios`, `id_perfil`, `nombre`, `apellido`, `usuario`, `contrasenia`, `fechamodificacion`, `idusuariomodificacion`, `activo`, `eliminado` FROM `usuarios` WHERE `id_perfil` in (3,4)";
        ...
        <p align="center">
            <input type="button" value="Guardar"  class="btn btn-primary" onclick="POSTConfigurarFormacion()" />
        </p>
    </form>
          </body>
</html>
