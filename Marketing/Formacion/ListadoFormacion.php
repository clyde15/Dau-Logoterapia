...
<html>
 ...
 <script src="../../js/PreguntasSeguridad.js" type="text/javascript"></script>
   ...
   <link rel="stylesheet" href="../../js/jquery-ui.css" media="all" type="text/css"  />
    ...
    <script src="../../Marketing/js/Formaciones.js" type="text/javascript"></script>
...
<div align="center">
<p align="center"><H3>Administrar Formaciones</H3></p>        
  ...
  <div class="col-md-6 col-md-offset-3">
      <table class="tablesorter table table-striped table-hover table-bordered table-condensed  " >  
        ...
        <tr >
           ...
           <a style="color:black" onclick="GETCrearFormacion()" ><img title="Crear Pregunta" alt="" SRC="../../wp-content/uploads/2015/10/AdmDipomado.png" width="50px"/></a>
   ...
   <tbody class="buscar">
         <?php   
        $query = "Select * from formacion where eliminado = 0";
        ...
        if ($resultados->fetch_array() == 0)
        {
           ...
           <td> <p align="center"><strong>No Hay Ninguna Formacion Registrado en nuestro sistema</strong></p> </td>
...
<?php
             if ($registros['Activo']) {
             ?>
                             <td width="50px"><a href="#" onclick="InactivarFormacion(<?php echo $registros['idformaciones']?>)"><img title="Activado" alt="" SRC="../../wp-content/uploads/2015/10/Habilitar.png" width="30px"/></a></td>
             <?php
             }  else {
              ?>
                             <td width="50px"><a href="#" onclick="ActivarFormacion(<?php echo $registros['idformaciones']?>)" style="color:black" ><img title="Desactivado" alt="" SRC="../../wp-content/uploads/2015/10/Deshabilitar.png" width="30px"/></a></td>
             <?php   
              }
           ?>
