   ...
   <?php   
    ...
    <tr >
         ...
         $iddiplomado = $registros['IDConfiguracion'];
             ...
             $queryCantidadPagosC = "select count(p.id_alumno) as cantidadalumnos, d.Descripcion, c.IDConfiguracion, p.id_tipoPago from diplomados d
			inner join configuraciones c on d.iddiplomados = c.ID_Diplomado
			inner join Pagos p on c.IDConfiguracion = p.ID_Configuracion
			inner join tipopagos tp on p.ID_TipoPago = tp.idTipoPagos
                        where p.ID_Configuracion = '$iddiplomado'
    ...
    $resultadosCantidadPagosC = $conexion->query($queryCantidadPagosC);
         ...
         ?>
         <td style=" text-align: center"> <a href="ListadoAlumnos.php?idconfiguracion=<?php echo $IDConfiguracion ?>&idtipopago=<?php echo $id_tipoPago ?>&PaginaRegresar=ListadoDiplomadosAlumnos.php" target="principal"><?php echo$registrosCantidadPagosC['cantidadalumnos'] ?></a> </td>  
         
             <?php
            
             $queryCantidadPagosCU = "select count(p.id_alumno) as cantidadalumnos, d.Descripcion, c.IDConfiguracion, p.id_tipoPago from diplomados d
			inner join configuraciones c on d.iddiplomados = c.ID_Diplomado
			inner join Pagos p on c.IDConfiguracion = p.ID_Configuracion
			inner join tipopagos tp on p.ID_TipoPago = tp.idTipoPagos
                        where p.ID_Configuracion = '$iddiplomado'
    ...
    $resultadosCantidadPagosCU = $conexion->query($queryCantidadPagosCU);
         ...
         ?>
         <td style=" text-align: center">  <a href="ListadoAlumnos.php?idconfiguracion=<?php echo $IDConfiguracion ?>&idtipopago=<?php echo $id_tipoPagoCuota?>&PaginaRegresar=ListadoDiplomadosAlumnos.php" target="principal"><?php echo$registrosCantidadPagosCU['cantidadalumnos'] ?></a> </td> 
      </tr>
