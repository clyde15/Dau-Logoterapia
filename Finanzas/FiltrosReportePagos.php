...
<script src="../js/FiltrosReportePagos.js"></script>
    ...
    <center>
        <table>
            ...
            <th class="AlumnosDiv" style="display: none">
                <div class="editor-label"><strong>Alumnos</strong></div>
        ...
        <td class="AlumnosDiv" style="display: none">
        <div class="editor-field" >
            
            <select id="AlumnoSeleccionado">
